            ...
            if (distribuidorPorEstado["lstDistribuidores"].length > 0) {
                for (var i = 0; i < distribuidorPorEstado["lstDistribuidores"].length; i++) {
                    smgtoTemporal.push({
                        ...
                        "lblDireccion2": distribuidorPorEstado["lstDistribuidores"][i]["colonia"] + ", " + distribuidorPorEstado["lstDistribuidores"][i]["codigoPostal"] + ", " + distribuidorPorEstado["lstDistribuidores"][i]["plaza"],
