...
function getSaldosMovimientosDetalle(status, lstDetalle) {
    if (lstDetalle != null && lstDetalle != undefined && lstDetalle["codigo"] != null && lstDetalle["codigo"] != undefined && lstDetalle["codigo"] == 1) {
        ...
        if (lstDetalle != null && lstDetalle != undefined && lstDetalle["codigo"] != null && lstDetalle["codigo"] != undefined) {
...
function getSaldosMovimientosDetalleAbono(status, lstDetalleAbono) {
    if (lstDetalleAbono != null && lstDetalleAbono != undefined && lstDetalleAbono["codigo"] != null && lstDetalleAbono["codigo"] != undefined && lstDetalleAbono["codigo"] == 1) {
