...
function detalleContratoR(status, detalleContrato) {
    if (detalleContrato != null && detalleContrato != undefined && detalleContrato["codigo"] != null && detalleContrato["codigo"] != undefined && detalleContrato["codigo"] == 1) {
        //kony.application.dismissLoadingScreen();
        //dismissLoader();
        var lstAseguradora;
        if (detalleContrato["lstContenido"] != null && detalleContrato["lstContenido"] != undefined) {
            var smgtoTemporal = [];
        ...
        if (detalleContrato != null && detalleContrato["codigo"] != null && detalleContrato != undefined && detalleContrato["codigo"] != undefined) {
...
function detalleContratoI(status, detalleContratoInfo) {
    if (detalleContratoInfo != null && detalleContratoInfo != undefined && detalleContratoInfo["codigo"] != null && detalleContratoInfo["codigo"] != undefined && detalleContratoInfo["codigo"] == 1) {
        ...
        if (detalleContratoInfo != null && detalleContratoInfo["codigo"] != null && detalleContratoInfo != undefined && detalleContratoInfo["codigo"] != undefined) {
