...
function getUbicaciones(status, distribuidorPorGps) {
    if (distribuidorPorGps != null && distribuidorPorGps["codigo"] != null && distribuidorPorGps != undefined && distribuidorPorGps["codigo"] != undefined && distribuidorPorGps["codigo"] == 1) {
        if (distribuidorPorGps["lstDistribuidores"] != null && distribuidorPorGps["lstDistribuidores"] != undefined) {
            var smgtoTemporal = [];
            if (distribuidorPorGps["lstDistribuidores"].length > 0) {
                for (var i = 0; i < distribuidorPorGps["lstDistribuidores"].length; i++) {
                    smgtoTemporal.push({
                        "lblAutomotriz": distribuidorPorGps["lstDistribuidores"][i]["nombre"],
                        "lblCalle": distribuidorPorGps["lstDistribuidores"][i]["calle"],
                        "lblPlaza": distribuidorPorGps["lstDistribuidores"][i]["colonia"] + ", " + distribuidorPorGps["lstDistribuidores"][i]["codigoPostal"] + ", " + distribuidorPorGps["lstDistribuidores"][i]["plaza"],
                        "lblDireccion1": distribuidorPorGps["lstDistribuidores"][i]["calle"],
                        "lblDireccion1": distribuidorPorGps["lstDistribuidores"][i]["colonia"] + ", " + distribuidorPorGps["lstDistribuidores"][i]["codigoPostal"] + ", " + distribuidorPorGps["lstDistribuidores"][i]["plaza"],
                        "lblTelefono": distribuidorPorGps["lstDistribuidores"][i]["telefono"],
                        "btnTelefono": distribuidorPorGps["lstDistribuidores"][i]["telefono"],
                        ...
                        "btnPagina": distribuidorPorGps["lstDistribuidores"][i]["paginaWeb"],
        ...
        if (distribuidorPorGps != null && distribuidorPorGps["codigo"] != null && distribuidorPorGps != undefined && distribuidorPorGps["codigo"] != undefined) {
...
function getEstados(status, lstEstados) {
    if (lstEstados != null && lstEstados != undefined && lstEstados["codigo"] != null && lstEstados["codigo"] != undefined && lstEstados["codigo"] == 1) {
        ...
        if (lstEstados != null && lstEstados["codigo"] != null && lstEstados != undefined && lstEstados["codigo"] != undefined) {
