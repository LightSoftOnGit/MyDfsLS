function addWidgetsfrmDistribuidores() {
    ...
    FlexContainer0ee09618a4a5b48.add(smgtoOpciones);
    ...
    var lstEstados = new kony.ui.ListBox({
    ...
    flexEstado.add(lblCiudad, lstEstados);
...
function frmDistribuidoresGlobals() {
    frmDistribuidores = new kony.ui.Form2({
        ...
        "onDeviceBack": AS_Form_360961f36e974b03b79ef499a34ff580,
