function addWidgetsfrmAjustesParquimetro() {
    ...
    imgTab.add(imgTabBg, richTextTitle, richTextUbicacion, checkBox, lblRecordatorio, btnMenos, btnMas, lblMinutos, lblActuvar, listBoxSegundos);
...
function frmAjustesParquimetroGlobals() {
    frmAjustesParquimetro = new kony.ui.Form2({
        ...
        "onDeviceBack": p2kwiet19724036341660_frmAjustesParquimetro_Android_onDeviceBack_seq0,
        "outTransitionConfig": {
            "formAnimation": 0
        },
