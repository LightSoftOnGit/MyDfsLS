...
function validarParametrosCalculo2() {
    var respuesta = (cotizadorCalculo2.lbEstados.masterData != null && cotizadorCalculo2.lbEstados.masterData != undefined && cotizadorCalculo2.lbEstados.masterData.length == 32 && cotizadorCalculo2.sliderPlazos.min != 2 && cotizadorCalculo2.txtPrecio.text.length == 0);
    if (respuesta == true) {
        alert("Capture un precio válido por favor");
        return false;
    }
    respuesta = (cotizadorCalculo2.lbEstados.masterData != null && cotizadorCalculo2.lbEstados.masterData != undefined && cotizadorCalculo2.lbEstados.masterData.length == 32 && cotizadorCalculo2.txtPrecio.text != null && cotizadorCalculo2.txtPrecio.text != undefined && cotizadorCalculo2.txtPrecio.text.length > 0 && cotizadorCalculo2.sliderPlazos.min != 2);
    return respuesta;
}
...
function validarPlazoSeleccionadoFlex(plazoSeleccionado) {
    ...
    if (lstPlazos != undefined && lstPlazos.length > 0) {
        lstPlazos.sort(function(a, b) {
            return parseInt(a.mesInicial) - parseInt(b.mesInicial)
        });
