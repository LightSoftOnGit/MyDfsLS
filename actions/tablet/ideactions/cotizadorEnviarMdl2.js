...
function validarParametrosEnvio2(){	
	...
	if(valor=='0') {
		res=(cotizadorEnviar2.txtEmail.text!=null && cotizadorEnviar2.txtEmail.text.length>0) 
		&& (cotizadorEnviar2.txtApellido.text!=null && cotizadorEnviar2.txtApellido.text.length>0) 
		&& (cotizadorEnviar2.txtNombre.text!=null && cotizadorEnviar2.txtNombre.text.length>0);
	
	} else{	
		res=(cotizadorEnviar2.txtEmail.text!=null && cotizadorEnviar2.txtEmail.text.length>0) 
		&& (cotizadorEnviar2.txtApellido.text!=null && cotizadorEnviar2.txtApellido.text.length>0) 
		&& (cotizadorEnviar2.txtNombre.text!=null && cotizadorEnviar2.txtNombre.text.length>0)
		&& (cotizadorEnviar2.txtTelefono.text!=null && cotizadorEnviar2.txtTelefono.text.length>0);
	}
