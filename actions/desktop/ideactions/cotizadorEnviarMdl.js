...
function validarParametrosEnvio(){	
	var res=(cotizadorEnviar.txtUserEmail.text!=null && cotizadorEnviar.txtUserEmail.text.length>0) 
		&& (cotizadorEnviar.txtUserLastName.text!=null && cotizadorEnviar.txtUserLastName.text.length>0) 
		&& (cotizadorEnviar.txtUserName.text!=null && cotizadorEnviar.txtUserName.text.length>0)
		&& (cotizadorEnviar.txtUserPhone.text!=null && cotizadorEnviar.txtUserPhone.text.length>0);
	return res;
} 
