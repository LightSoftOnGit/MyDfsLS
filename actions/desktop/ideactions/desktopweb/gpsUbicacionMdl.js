function gpsVerMapa() {
    ...
    if (kony.os.deviceInfo().name == "iPhone" || kony.os.deviceInfo().name == "iPad" || kony.os.deviceInfo().name == "iPhone Simulator" || kony.os.deviceInfo().name == "iPad Simulator") drctnUrl = "https://maps.apple.com?saddr=" + latitud + "," + longitud + "&daddr=" + latitudDestino + "," + longitudDestino;
    else if (kony.os.deviceInfo().name == "android") drctnUrl = "https://maps.google.com/maps?saddr=" + latitud + "," + longitud + "&daddr=" + latitudDestino + "," + longitudDestino;
...
function gpsVerPaginaWeb() {
    ...
    if (paginaWeb != null) {
        var protocolo = "http://"
        if (paginaWeb.indexOf(protocolo) > -1) kony.application.openURL(paginaWeb);
        else kony.application.openURL("http://" + paginaWeb);
    } else {
