...
function showLoader(){
	...
	var basicConfImage ={id : "imageIdTest", isVisible:true, src:"buffer_loader.png", imageWhenFailed:"buffer_loader.png", imageWhileDownloading:"buffer_loader.png"};
	...
	var popBasic ={id:"popUp", skin:"popHtmlSk", isModal:true, transparencyBehindThePopup:50};
	var popLayout ={containerWeight:20,padding:[5,5,5,5]};
	var popPSP ={footerOverlap:false, captureGPS:false, windowSoftInputMode:constants.POPUP_ADJUST_RESIZE};
	popUpCargar=new kony.ui.Popup(popBasic, popLayout, popPSP);
	popUpCargar.show();
	
}
function dismissLoader(){
	if(popUpCargar != null && popUpCargar != undefined 
		&& frmCarga != null && frmCarga != undefined
		&& frmCarga.imageIdTest != null && frmCarga.imageIdTest != undefined){
		popUpCargar.destroy();
