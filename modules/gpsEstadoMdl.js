...
function gpsUbicacionDistribuidorEstado(status, distribuidorPorEstado) {
	...
	if(distribuidorPorEstado != null && distribuidorPorEstado != undefined && 
	   distribuidorPorEstado["codigo"] != null && distribuidorPorEstado["codigo"] != undefined && 
	   distribuidorPorEstado["codigo"]==1){
		
		if (distribuidorPorEstado["lstDistribuidores"] != null && 
			distribuidorPorEstado["lstDistribuidores"] != undefined) {
			var smgtoTemporal = [];
			if(distribuidorPorEstado["lstDistribuidores"].length>0){
				for (var i = 0; i < distribuidorPorEstado["lstDistribuidores"].length; i++) {
		        	smgtoTemporal.push({
		                "lblAutomotriz": distribuidorPorEstado["lstDistribuidores"][i]["nombre"],
		                "lblCalle": distribuidorPorEstado["lstDistribuidores"][i]["calle"],
		                "lblPlaza": distribuidorPorEstado["lstDistribuidores"][i]["colonia"]+", "+
		                			distribuidorPorEstado["lstDistribuidores"][i]["codigoPostal"]+", "+
		                			distribuidorPorEstado["lstDistribuidores"][i]["plaza"],
		                "lblDireccion1": distribuidorPorEstado["lstDistribuidores"][i]["calle"],
		                "lblDireccion2": distribuidorPorEstado["lstDistribuidores"][i]["colonia"]+", "+
		                			distribuidorPorEstado["lstDistribuidores"][i]["codigoPostal"]+", "+
		                			distribuidorPorEstado["lstDistribuidores"][i]["plaza"],
						"lblTelefono": distribuidorPorEstado["lstDistribuidores"][i]["telefono"],
						"btnTelefono": distribuidorPorEstado["lstDistribuidores"][i]["telefono"],
		                ...
		                "btnPagina": distribuidorPorEstado["lstDistribuidores"][i]["paginaWeb"],
		...
		if(distribuidorPorEstado !=null && distribuidorPorEstado["codigo"]!=null &&
		   distribuidorPorEstado !=undefined && distribuidorPorEstado["codigo"]!=undefined){
